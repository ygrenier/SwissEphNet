...
namespace SwissEphNet.CPort
{
    ...
    partial class SwepCalc
    {
        ...
        public double d2l(double x) { return SE.swe_d2l(x); }
        public double difcsn(int x, int y) { return SE.swe_difcsn(x, y); }
        public double difcs2n(int x, int y) { return SE.swe_difcs2n(x, y); }
        public double difdegn(double x, double y) { return SE.swe_difdegn(x, y); }
        public double difdeg2n(double x, double y) { return SE.swe_difdeg2n(x, y); }
        public double csnorm(int x) { return SE.swe_csnorm(x); }
        public double degnorm(double x) { return SE.swe_degnorm(x); }
        public double roundsec(int x) { return SE.swe_csroundsec(x); }
        //#endif
