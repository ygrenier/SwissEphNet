        ...
        //class swhel {
            ...
            */
            double OpticFactor(double Bback, double kX, double[] dobs, double JDNDaysUT, string ObjectName, int TypeFactor, int helflag) {
                ...
                if (Bback < BNIGHT && 0 == (helflag & SE_HELFLAG_VISLIM_PHOTOPIC)) {
            ...
            */
            ...
            Int32 call_swe_fixstar(string star, double tjd, Int32 iflag, double[] xx, ref string serr) {
                Int32 retval;
                string star2 = star;
                retval = swe_fixstar(star2, tjd, iflag, xx, ref serr);
                return retval;
            }
            ...
            Int32 call_swe_fixstar_mag(string star, ref double mag, ref string serr) {
                ...
                star2 = star;
                retval = swe_fixstar_mag(ref star2, ref call_swe_fixstar_mag_dmag, ref serr);
                mag = call_swe_fixstar_mag_dmag;
                return retval;
            }
            ...
            Int32 call_swe_rise_trans(double tjd, Int32 ipl, string star, Int32 helflag, Int32 eventtype, double[] dgeo, double atpress, double attemp, ref double tret, ref string serr) {
                ...
                string star2 = star;
                retval = swe_rise_trans(tjd, ipl, star2, iflag, eventtype, dgeo, atpress, attemp, ref tret, ref serr);
                return retval;
            }
            ...
            Int32 calc_rise_and_set(double tjd_start, Int32 ipl, double[] dgeo, double[] datm, Int32 eventflag, Int32 helflag, ref double trise, ref string serr) {
                ...
                rdi = Math.Asin(696000000.0 / 1.49597870691e+11 / xx[2]) / DEGTORAD;
                if ((eventflag & SE_BIT_DISC_CENTER) != 0)
                    rdi = 0;
                ...
                sda = Math.Acos(-Math.Tan(dgeo[1] * DEGTORAD) * Math.Tan(xx[1] * DEGTORAD)) * RADTODEG;
            ...
            */
            ...
            double SunRA(double JDNDaysUT, Int32 helflag, ref string serr) {
                int imon = 0, iday = 0, iyar = 0, calflag = SE_GREG_CAL;
                double dut = 0;
                if (JDNDaysUT == SunRA_tjdlast)
                    return SunRA_ralast;
                if (SIMULATE_VICTORVB) {
                ...
                swe_revjul(JDNDaysUT, calflag, ref iyar, ref imon, ref iday, ref dut); /* this seems to be much faster than calling swe_revjul() ! Note: only because SunRA is called 1000s of times */
                SunRA_tjdlast = JDNDaysUT;
                SunRA_ralast = swe_degnorm((imon + (iday - 1) / 30.4 - 3.69) * 30);
            ...
            */
            double DeltaTVR(double JDNDays, int COD) {
                ...
                OffSetYear = (swe_julday((int)StartYear, 1, 1, 0, gregflag) - JDNDays) / 365.25;
                if (COD == 0) {
                    DeltaTVR = (OffSetYear * OffSetYear / 100.0 / 2.0 * Average + Periodicy / 2.0 / PI * Amplitude * (Math.Cos((2 * PI * OffSetYear / Periodicy)) - 1)) * Y2D;
                } else {
            ...
            */
            ...
            static double kOZ(double AltS, double sunra, double Lat) {
                ...
                LT = Lat * DEGTORAD;
                /* From Schaefer , Archaeoastronomy, XV, 2000, page 128*/
                kOZret = OZ * (3.0 + 0.4 * (LT * Math.Cos(sunra * DEGTORAD) - Math.Cos(3 * LT))) / 3.0;
            ...
            */
            double Bn(double AltO, double JDNDayUT, double AltS, double sunra, double Lat, double HeightEye, double[] datm, Int32 helflag, ref string serr) {
                ...
                swe_revjul(JDNDayUT, SE_GREG_CAL, ref iyar, ref imon, ref iday, ref dut);
            ...
            */
            Int32 Magnitude(double JDNDaysUT, double[] dgeo, string ObjectName, Int32 helflag, ref double dmag, ref string serr) {
                ...
                if (Planet != -1) {
                    ...
                    if (swe_pheno_ut(JDNDaysUT, Planet, iflag, x, ref serr) == ERR)
                        return ERR;
                    dmag = x[4];
                } else {
                    if (call_swe_fixstar_mag(ObjectName, ref dmag, ref serr) == ERR)
                        return ERR;
                }
                return OK;
            }
            ...
            */
            static double MoonPhase(double AltM, double AziM, double AziS) {
                ...
                return 180 - Math.Acos(Math.Cos(AziSi - AziMi) * Math.Cos(AltMi + 0.95 * DEGTORAD)) / DEGTORAD;
            }
            ...
            */
            static double Bm(double AltO, double AziO, double AltM, double AziM, double AltS, double AziS, double sunra, double Lat, double HeightEye, double[] datm, Int32 helflag, ref string serr) {
                ...
                if (AltM > -0.26) {
                    ...
                    FM = (62000000.0) / RM / RM + Math.Pow(10, 6.15 - RM / 40) + Math.Pow(10, 5.36) * (1.06 + Math.Pow(Math.Cos(RM * DEGTORAD), 2));
            ...
            */
            static double Bday(double AltO, double AziO, double AltS, double AziS, double sunra, double Lat, double HeightEye, double[] datm, Int32 helflag, ref string serr) {
                ...
                double FS = (62000000.0) / RS / RS + Math.Pow(10, (6.15 - RS / 40)) + Math.Pow(10, 5.36) * (1.06 + Math.Pow(Math.Cos(RS * DEGTORAD), 2));
            ...
            */
            ...
            static void default_heliacal_parameters(double[] datm, double[] dgeo, double[] dobs, int helflag) {
                ...
                if (dobs[1] == 0)
                    dobs[1] = 1;
                if (0 == (helflag & SE_HELFLAG_OPTICAL_PARAMS)) {
                    for (i = 2; i <= 5; i++)
                        dobs[i] = 0;
                }
            ...
            */
            double VisLimMagn(double[] dobs, double AltO, double AziO, double AltM, double AziM, double JDNDaysUT, double AltS, double AziS, double sunra, double Lat, double HeightEye, double[] datm, Int32 helflag, ref Int32 scotopic_flag, ref string serr) {
                ...
                /* From Schaefer , Archaeoastronomy, XV, 2000, page 129*/
                if (Bsk < BNIGHT && 0 == (helflag & SE_HELFLAG_VISLIM_PHOTOPIC)) {
            ...
            */
            protected Int32 swe_vis_limit_mag(double tjdut, double[] dgeo, double[] datm, double[] dobs, string ObjectName, Int32 helflag, double[] dret, ref string serr) {
                ...
                for (i = 0; i < 7; i++)
                    dret[i] = 0;
                if (ObjectLoc(tjdut, dgeo, datm, ObjectName, 0, helflag, ref AltO, ref serr) == ERR)
                    return ERR;
                if (AltO < 0) {
                ...
                if (ObjectLoc(tjdut, dgeo, datm, ObjectName, 1, helflag, ref AziO, ref serr) == ERR)
                    return ERR;
                if ((helflag & SE_HELFLAG_VISLIM_DARK) != 0) {
                    AltS = -90;
                    AziS = 0;
                } else {
                    if (ObjectLoc(tjdut, dgeo, datm, "sun", 0, helflag, ref AltS, ref serr) == ERR)
                        return ERR;
                    if (ObjectLoc(tjdut, dgeo, datm, "sun", 1, helflag, ref AziS, ref serr) == ERR)
                        return ERR;
                }
                if (ObjectName.StartsWith("moon") ||
                    (helflag & SE_HELFLAG_VISLIM_DARK) != 0 ||
                    (helflag & SE_HELFLAG_VISLIM_NOMOON) != 0
                   ) {
                    AltM = -90; AziM = 0;
                } else {
                    if (ObjectLoc(tjdut, dgeo, datm, "moon", 0, helflag, ref AltM, ref serr) == ERR)
                        return ERR;
                    if (ObjectLoc(tjdut, dgeo, datm, "moon", 1, helflag, ref AziM, ref serr) == ERR)
                        return ERR;
                }
#if DEBUG
                {
                ...
                dret[5] = AltM;
                dret[6] = AziM;
                if (Magnitude(tjdut, dgeo, ObjectName, helflag, ref (dret[7]), ref serr) == ERR)
                    return ERR;
            ...
            */
            Int32 HeliacalAngle(double Magn, double[] dobs, double AziO, double AltM, double AziM, double JDNDaysUT, double AziS, double[] dgeo, double[] datm, Int32 helflag, double[] dangret, ref string serr) {
                ...
                ymin = 10000;
                for (x = minx; x <= maxx; x++) {
                    if (TopoArcVisionis(Magn, dobs, x, AziO, AltM, AziM, JDNDaysUT, AziS, sunra, Lat, HeightEye, datm, helflag, ref Arc, ref serr) == ERR)
                        return ERR;
                    if (Arc < ymin) {
                        ymin = Arc;
                        xmin = x;
                ...
                Xl = xmin - 1;
                xR = xmin + 1;
                if (TopoArcVisionis(Magn, dobs, xR, AziO, AltM, AziM, JDNDaysUT, AziS, sunra, Lat, HeightEye, datm, helflag, ref Yr, ref serr) == ERR)
                    return ERR;
                if (TopoArcVisionis(Magn, dobs, Xl, AziO, AltM, AziM, JDNDaysUT, AziS, sunra, Lat, HeightEye, datm, helflag, ref Yl, ref serr) == ERR)
                    return ERR;
                /* http://en.wikipedia.org/wiki/Bisection_method*/
                while (Math.Abs(xR - Xl) > 0.1) {
                    ...
                    DELTAx = 0.025;
                    xmd = Xm + DELTAx;
                    if (TopoArcVisionis(Magn, dobs, Xm, AziO, AltM, AziM, JDNDaysUT, AziS, sunra, Lat, HeightEye, datm, helflag, ref Ym, ref serr) == ERR)
                        return ERR;
                    if (TopoArcVisionis(Magn, dobs, xmd, AziO, AltM, AziM, JDNDaysUT, AziS, sunra, Lat, HeightEye, datm, helflag, ref ymd, ref serr) == ERR)
                        return ERR;
                    if (Ym >= ymd) {
                        /* Throw away left half */
                        Xl = Xm;
            ...
            */
            ...
            Int32 DeterTAV(double[] dobs, double JDNDaysUT, double[] dgeo, double[] datm, string ObjectName, Int32 helflag, ref double dret, ref string serr) {
                ...
                double sunra = SunRA(JDNDaysUT, helflag, ref serr);
                if (Magnitude(JDNDaysUT, dgeo, ObjectName, helflag, ref Magn, ref serr) == ERR)
                    return ERR;
                if (ObjectLoc(JDNDaysUT, dgeo, datm, ObjectName, 0, helflag, ref AltO, ref serr) == ERR)
                    return ERR;
                if (ObjectLoc(JDNDaysUT, dgeo, datm, ObjectName, 1, helflag, ref AziO, ref serr) == ERR)
                    return ERR;
                if (ObjectName.StartsWith("moon")) {
                    AltM = -90;
                    AziM = 0;
                } else {
                    if (ObjectLoc(JDNDaysUT, dgeo, datm, "moon", 0, helflag, ref AltM, ref serr) == ERR)
                        return ERR;
                    if (ObjectLoc(JDNDaysUT, dgeo, datm, "moon", 1, helflag, ref AziM, ref serr) == ERR)
                        return ERR;
                }
                if (ObjectLoc(JDNDaysUT, dgeo, datm, "sun", 1, helflag, ref AziS, ref serr) == ERR)
                    return ERR;
                if (TopoArcVisionis(Magn, dobs, AltO, AziO, AltM, AziM, JDNDaysUT, AziS, sunra, dgeo[1], dgeo[2], datm, helflag, ref dret, ref serr) == ERR)
                    return ERR;
                return OK;
            }
            ...
            */
            protected Int32 swe_heliacal_pheno_ut(double JDNDaysUT, double[] dgeo, double[] datm, double[] dobs, string ObjectNameIn, Int32 TypeEvent, Int32 helflag, double[] darr, ref string serr) {
                ...
                ParO = GeoAltO - AltO;
                if (Magnitude(JDNDaysUT, dgeo, ObjectName, helflag, ref MagnO, ref  serr) == ERR)
                    return ERR;
                ARCVact = TAVact + ParO;
                ARCLact = Math.Acos(Math.Cos(ARCVact * DEGTORAD) * Math.Cos(DAZact * DEGTORAD)) / DEGTORAD;
                Planet = DeterObject(ObjectName);
                if (Planet == -1) {
                    elong = ARCLact;
                    illum = 100;
                } else {
                    retval = swe_pheno_ut(JDNDaysUT, Planet, iflag | (SEFLG_TOPOCTR | SEFLG_EQUATORIAL), attr, ref serr);
                ...
                do {
                    ...
                    if (DeterTAV(dobs, TimePointer, dgeo, datm, ObjectName, helflag, ref MinTAVact, ref serr) == ERR)
                        return ERR;
                    if (MinTAVoud < MinTAVact && TbVR == 0) {
                        ...
                        if (DeterTAV(dobs, TimeCheck, dgeo, datm, ObjectName, helflag, ref LocalminCheck, ref serr) == ERR)
                            return ERR;
            ...
            Int32 moon_event_arc_vis(double JDNDaysUTStart, double[] dgeo, double[] datm, double[] dobs, Int32 TypeEvent, Int32 helflag, double[] dret, ref string serr) {
                ...
                swe_pheno_ut(JDNDaysUT, Planet, iflag, x, ref serr);
                phase2 = x[0];
                goingup = 0;
                do {
                ...
                do {
                    JDNDaysUT = JDNDaysUT + Daystep;
                    if ((retval = RiseSet(JDNDaysUT, dgeo, datm, ObjectName, TypeEvent, helflag, 0, ref tjd_moonevent, ref serr)) != OK)
                        return retval;
                    ...
                    do {
                        ...
                        if (ObjectLoc(tjd_moonevent, dgeo, datm, "sun", 0, helflag, ref AltS, ref  serr) == ERR)
                            return ERR;
                        if (ObjectLoc(tjd_moonevent, dgeo, datm, ObjectName, 0, helflag, ref AltO, ref serr) == ERR)
                            return ERR;
                        DeltaAlt = AltO - AltS;
                        if (DeterTAV(dobs, tjd_moonevent, dgeo, datm, ObjectName, helflag, ref MinTAV, ref serr) == ERR)
                            return ERR;
            ...
            Int32 heliacal_ut_arc_vis(double JDNDaysUTStart, double[] dgeo, double[] datm, double[] dobs, string ObjectName, Int32 TypeEventIn, Int32 helflag, double[] dret, ref string serr_ret) {
                ...
                if ((retval = Magnitude(JDNDaysUTStart, dgeo, ObjectName, helflag, ref objectmagn, ref serr)) == ERR)
                ...
                /* normalize the maxlength to the step size */
                {
                    ...
                    do { /* this is a do {} while() loop */
                        ...
                        do { /* this is a do {} while() loop */
                            ...
                            if ((retval = my_rise_trans(JDNDaysUTstep, SE_SUN, "", eventtype, helflag, dgeo, datm, ref tret, ref serr)) == ERR)
                                goto swe_heliacal_err;
                            ...
                            if ((retval = HeliacalAngle(objectmagn, dobs, AziO, -1, 0, JDNarcvisUT, AziS, dgeo, datm, helflag, dang, ref  serr)) == ERR)
                                goto swe_heliacal_err;
                            ArcusVis = dang[1];
                            ArcusVisPto = dang[2];
                ...
                if ((helflag & SE_HELFLAG_AVKIND_VR) != 0) {
                    ...
                    if (DeterTAV(dobs, TimePointer, dgeo, datm, ObjectName, helflag, ref OldestMinTAV, ref serr) == ERR)
                        return ERR;
                    TimePointer = TimePointer + TimeStep;
                    if (DeterTAV(dobs, TimePointer, dgeo, datm, ObjectName, helflag, ref MinTAVoud, ref serr) == ERR)
                        return ERR;
            ...
            Int32 get_asc_obl_diff(double tjd, Int32 ipl, string star, Int32 iflag, double[] dgeo, bool desc_obl, bool is_acronychal, ref double dsunpl, ref string serr) {
                ...
                retval = get_asc_obl(tjd, SE_SUN, "", iflag, dgeo, desc_obl, ref aosun, ref serr);
                if (retval != OK)
                    return retval;
                if (is_acronychal) {
                    if (desc_obl == true)
            ...
            Int32 get_heliacal_day(double tjd, double[] dgeo, double[] datm, double[] dobs, string ObjectName, Int32 helflag, Int32 TypeEvent, ref double thel, ref string serr) {
                ...
                for (tday = tjd;
                    ...
                    vdelta = -100;
                    if ((retval = my_rise_trans(tday, SE_SUN, "", is_rise_or_set, helflag, dgeo, datm, ref tret, ref serr)) == ERR)
                        return ERR;
            ...
            Int32 get_acronychal_day(double tjd, double[] dgeo, double[] datm, double[] dobs, string ObjectName, Int32 helflag, Int32 TypeEvent, ref double thel, ref string serr) {
                ...
                while (Math.Abs(dtret) > 0.5 / 1440.0) {
                    ...
                    retval = time_limit_invisible(tjd, dgeo, datm, dobs, ObjectName, helflag | SE_HELFLAG_VISLIM_DARK, direct, ref tret_dark, ref serr);
                    if (retval == ERR) return ERR;
                    retval = time_limit_invisible(tjd, dgeo, datm, dobs, ObjectName, helflag | SE_HELFLAG_VISLIM_NOMOON, direct, ref tret, ref serr);
                    if (retval == ERR) return ERR;
                    //#if 0
                ...
                if (azalt_cart(tret, dgeo, datm, "sun", helflag, darr, ref serr) == ERR)
                    return ERR;
                thel = tret;
                if (darr[1] < -12) {
            ...
            Int32 heliacal_ut_vis_lim(double tjd_start, double[] dgeo, double[] datm, double[] dobs, string ObjectName, Int32 TypeEventIn, Int32 helflag, double[] dret, ref string serr_ret) {
                ...
                if (ipl == SE_MERCURY || ipl == SE_VENUS || TypeEvent <= 2) {
                    if (ipl == -1) {
                        ...
                        if ((retval = find_conjunct_sun(tjd, ipl, helflag, TypeEvent, ref tjd, ref serr)) == ERR)
                            goto swe_heliacal_err;
                    }
                    /* find the day and minute on which the object becomes visible */
                ...
                dret[0] = tday;
                if (0 == (helflag & SE_HELFLAG_NO_DETAILS)) {
            ...
            Int32 moon_event_vis_lim(double tjdstart, double[] dgeo, double[] datm, double[] dobs, Int32 TypeEvent, Int32 helflag, double[] dret, ref string serr_ret) {
                ...
                if (TypeEvent == 3) {
                    if ((retval = my_rise_trans(tjd, SE_SUN, "", SE_CALC_SET, helflag, dgeo, datm, ref trise, ref serr)) == ERR)
                        return ERR;
                    if (trise < dret[1]) {
                        dret[0] = trise;
                    ...
                    if ((retval = my_rise_trans(dret[1], SE_SUN, "", SE_CALC_RISE, helflag, dgeo, datm, ref trise, ref  serr)) == ERR)
                        return ERR;
                    if (dret[0] > trise) {
                        dret[0] = trise;
                        /* do not warn, it happens too often */
            ...
            */
            public Int32 swe_heliacal_ut(double JDNDaysUTStart, double[] dgeo, double[] datm, double[] dobs, string ObjectNameIn, Int32 TypeEvent, Int32 helflag, double[] dret, ref string serr_ret) {
                 ...
                 */
                if (0 == (helflag & SE_HELFLAG_AVKIND)) {
                    if (Planet == -1 || Planet >= SE_MARS) {
                        if (TypeEvent == 3 || TypeEvent == 4) {
                            if (Planet == -1)
                                s = ObjectName;
                            else
                                s = swe_get_planet_name(Planet);
                 ...
                 */
                if ((helflag & SE_HELFLAG_SEARCH_1_PERIOD) != 0 && (retval == -2 || dret[0] > tjd0 + dsynperiod * 1.5)) {
