...
namespace SweNet
{
    ...
    partial class SwissEph
    {
        ...
        */
        ...
        public const double SUN_RADIUS = (959.63 / 3600 * DEGTORAD);  /*  Meeus germ. p 391 */
        ...
        public const double SSY_PLANE_NODE_E2000 = (107.582569 * DEGTORAD);
        /* node of ecliptic measured on solar system rotation plane */
        public const double SSY_PLANE_NODE = (107.58883388 * DEGTORAD);
        /* inclination of ecliptic against solar system rotation plane */
        public const double SSY_PLANE_INCL = (1.578701 * DEGTORAD);
         ...
         */
        struct aya_init { public double t0; public double ayan_t0;};
        static aya_init[] ayanamsa = new aya_init[]{
        ...
        ************************************************************/
        ...
        const double STR = 4.8481368110953599359e-6; /* radians per arc second */
        ...
        class swe_data
        {
            public swe_data() {
                ...
                savedat = Enumerable.Range(0, SE_NPLANETS + 1).Select(i => new save_positions()).ToArray();
