    ...
    partial class SwissEphTest
    {
        ...
        public void Test_swe_azalt() {
            using (var swe = new SwissEph()) {
                ...
                Assert.AreEqual(249.64242931513104, xaz[0], 0.000000000001);
                Assert.AreEqual(-32.8340765334715, xaz[1], 0.000000000001);
                Assert.AreEqual(-32.8340765334715, xaz[2], 0.000000000001);
            }
        }
    }
